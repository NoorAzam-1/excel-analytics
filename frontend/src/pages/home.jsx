...
const Home = () => {
  return (
    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans flex flex-col">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-3 md:px-6 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 space-y-6 md:space-y-10 mb-16 md:mb-0 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4 sm:space-x-8 pt-4">
              ...
              <Link
                to="/dashboard"
                className="border-2 border-pink-500 text-pink-500 hover:bg-pink-500 hover:text-white px-6 md:px-2 lg:px-12 py-3 sm:py-4 rounded-full font-bold transition transform hover:-translate-y-1 text-sm sm:text-base"
              >
                Dashboard
              </Link>
            </div>
      ...
      <section className="bg-gray-800 lg:rounded-t-[5rem] shadow-2xl py-6 px-2 md:py-24 md:px-6 relative z-20">
